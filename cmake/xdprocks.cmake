...
SET(ROCKSDB_SOURCES_DIR ${CMAKE_SOURCE_DIR}/contrib/xdprocks)
SET(ROCKSDB_BINARY_DIR ${THIRD_PARTY_PATH}/build/xdprocks)
SET(ROCKSDB_INSTALL_DIR ${THIRD_PARTY_PATH}/install/xdprocks)
SET(ROCKSDB_INCLUDE_DIR "${ROCKSDB_INSTALL_DIR}/include" CACHE PATH "rocksdb include directory." FORCE)
SET(ROCKSDB_LIBRARIES "${ROCKSDB_INSTALL_DIR}/lib/libxdprocks.so" CACHE FILEPATH "rocksdb library." FORCE)
